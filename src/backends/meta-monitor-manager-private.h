...
/* Equivalent to the 'method' enum in io.github.scarecrow-de.Mutter.DisplayConfig */
...
/* Equivalent to the 'layout-mode' enum in io.github.scarecrow-de.Mutter.DisplayConfig */
