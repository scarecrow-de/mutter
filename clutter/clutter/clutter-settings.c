...
get_font_gsettings (GSettings    *xsettings,
                    FontSettings *output)
{
  /* io.github.scarecrow-de.settings-daemon.GsdFontAntialiasingMode */
  static const struct
  {
    cairo_antialias_t cairo_antialias;
    gint clutter_font_antialias;
  ...
  /* io.github.scarecrow-de.settings-daemon.GsdFontHinting */
  static const struct
  {
    cairo_hint_style_t cairo_hint_style;
    const char *clutter_font_hint_style;
  ...
  /* io.github.scarecrow-de.settings-daemon.GsdFontRgbaOrder */
  static const struct
  {
    cairo_subpixel_order_t cairo_subpixel_order;
    const char *clutter_font_subpixel_order;
...
load_initial_settings (ClutterSettings *self)
{
  static const gchar xsettings_path[] =
    "io.github.scarecrow-de.settings-daemon.plugins.xsettings";
